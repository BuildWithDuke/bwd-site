    ...
    <Link href={`/projects/${project.id}`}>
      ...
      <div className="p-6">
        ...
        <div className="flex gap-3 text-sm">
          {project.demoUrl && (
            <span className="text-accent hover:text-accent-hover transition-colors flex items-center gap-1">
              <span>Live Demo</span>
          ...
          {project.githubUrl && (
            <span className="text-foreground/60 hover:text-foreground transition-colors flex items-center gap-1">
              <span>Code</span>
