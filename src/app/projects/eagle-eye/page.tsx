...
export default function EagleEyeProject() {
  ...
  const features = [
    'AI-powered intelligent responses to Google reviews using local LLM',
    'Automated review monitoring and sentiment analysis',
    'Multi-business dashboard for centralized review management',
    'Celery task queue for scalable background processing'
  ];
      ...
      >
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg md:text-xl text-foreground/70 max-w-2xl mx-auto">
            AI-powered B2B SaaS platform for managing and responding to online Google reviews with intelligent, context-aware responses
          </p>
        </div>
        ...
        >
          ...
          <div className="prose prose-lg max-w-none text-foreground/80">
            <p className="mb-4">
              Managing online reviews is critical for business reputation, but responding to each review manually is time-consuming 
              and often inconsistent. Eagle Eye solves this by using locally hosted AI models to generate contextually appropriate, 
              personalized responses that maintain your brand voice.
            </p>
            <p>
              Built as a B2B SaaS platform, Eagle Eye integrates with Google My Business to monitor reviews in real-time, 
              analyze sentiment, and generate intelligent responses using Ollama-powered local language models. 
              The system ensures privacy by keeping all data processing on-premises while delivering enterprise-grade scalability.
            </p>
          </div>
        </motion.div>
