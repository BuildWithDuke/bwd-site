      ...
      >
        ...
        >
          ...
          <div className="prose prose-lg max-w-none text-foreground/80">
            <p className="mb-4">
              Course selection at UWaterloo can be overwhelming with thousands of options across different faculties. 
              Compass solves this by using a custom-built recommendation algorithm that combines locally hosted embedding models 
              with cosine similarity calculations and personalized weighting factors.
            </p>
            <p>
              The system uses Neo4j to model complex relationships between courses, prerequisites, and academic pathways, 
              while keeping all AI processing local for privacy and performance. The result is highly accurate course recommendations 
              tailored to individual student goals and academic history.
            </p>
          </div>
        </motion.div>
        ...
        >
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a 
              href="https://github.com/DukeofWaterloo/Compass"
              target="_blank"
