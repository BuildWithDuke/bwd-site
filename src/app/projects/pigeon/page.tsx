      ...
      >
        ...
        <div className="text-center mb-16">
          <div className="flex items-center justify-center gap-3 mb-6">
            ...
            <span className="px-3 py-1 text-sm bg-yellow-500/10 text-yellow-500 rounded-full border border-yellow-500/20">
              Development
            </span>
          </div>
        ...
        >
          ...
          <div className="prose prose-lg max-w-none text-foreground/80">
            <p className="mb-4">
              Sometimes you need to share files quickly within a trusted network without the overhead of accounts, 
              permissions, or permanent storage. Pigeon solves this with a dead-simple file sharing service that 
              automatically cleans up after itself, making it perfect for temporary collaboration and quick transfers.
            </p>
            <p>
              Built with Node.js and Express, Pigeon focuses on simplicity and reliability. Files are automatically 
              deleted after configurable time periods, large files are handled through efficient streaming, 
              and the entire system can be deployed anywhere with Docker. No databases, no user management - just fast, 
        ...
        >
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a 
              href="https://github.com/DukeofWaterloo/pigeon"
              target="_blank"
