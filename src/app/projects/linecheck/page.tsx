...
export default function LineCheckProject() {
  const techStack = ['Python', 'PyTorch', 'FastAI', 'ResNet-34', 'FastAPI', 'Docker'];
      ...
      >
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg md:text-xl text-foreground/70 max-w-2xl mx-auto">
            AI-powered computer vision system detecting damaged electrical insulators in power transmission lines with 99.38% accuracy
          </p>
        </div>
        ...
        >
          ...
          <div className="prose prose-lg max-w-none text-foreground/80">
            <p className="mb-4">
              Power transmission infrastructure requires constant monitoring to prevent outages and ensure grid reliability. 
              Traditional manual inspections are time-consuming, expensive, and often miss critical damage that could lead to failures.
              LineCheck automates this process using computer vision to detect damaged insulators with near-perfect accuracy.
            </p>
            <p>
              Built with FastAI and PyTorch, the system uses a fine-tuned ResNet-34 architecture trained on thousands of power 
              infrastructure images. The model can identify various types of insulator damage including cracks, contamination, 
              and structural failures that human inspectors might miss.
            </p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="bg-muted/50 border border-border rounded-lg p-8">
            <div className="aspect-video bg-gradient-to-br from-accent/10 to-accent-hover/10 rounded-lg overflow-hidden">
              <video 
                ...
                preload="metadata"
              >
                <source src="/projects/linecheck_video.mp4" type="video/mp4" />
        ...
        >
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a 
              href="https://github.com/DukeofWaterloo/LineCheck"
              target="_blank"
            ...
            <a
              href="https://linecheck.buildwithduke.com"
              target="_blank"
              rel="noopener noreferrer"
